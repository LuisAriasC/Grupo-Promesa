...
<head>
	<meta charset="utf-8">
	<title>Grupo Promesa | Vivienda</title>
					...
					<div class="ui dropdown menu-item item">
						<div id="active" class="text">NUESTROS PROGRAMAS</div>
					  	...
					  	<div class="menu ui transition hidden">
							...
							<a href="viviendaPromesa.php" class="active item">Vivienda</a>
				...
				<section id="parallax"  class="section">
					<div class="ui container">
						...
						<div class="wow fadeInUp">
							...
							<div class="ui container">
								<h2>
									Desarrollamos un programa Integral de reciclaje para que las viviendas puedan aprovechar su reciclaje y construir un mejor entorno ambiental
								</h2>
							</div>
							<br>
						</div>
